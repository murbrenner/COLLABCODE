...
PROPRIEDADE TRANSITION - FAZ ANIMAÇÃO (CORES, TAMANHO)
-COLOCAR TBM NA CLASSE COMUM, SEM HOVER, PRA PODER ANIMAR QUANDO REMOVE O MOUSE
...
PROPRIEDADE AFTER - COLOCA-SE DEPOIS DA CLASS NO CSS SEGUIDO DE ":"
-É UMA FORMA DE CRIAR UM ELEMENTO NO CSS PQ NÃO RECOMENDA-SE CRIAR NADA VAZIO NO HTML
-COLOCAR OBRIGATORIAMENTE A TAG CONTENT E NÃO DAR VALOR PRA PODER CRIAR ALGO VAZIO NO CSS
.pai > .filho:after {
	content: "";
}

TAG TRANSFORM-ORIGIN - MUDA A ÂNCORA DO ELEMENTO
-PRIMEIRO PARÂMETRO É DO EIXO Y E O SEGUNDO DO EIXO X
transform-origin: center left;

PROPRIEDADE @MEDIA - BREAKPOINT DA PAGE
-SETA A ADAPTAÇÃO RESPONSIVA DA QUANDO ATINGE DETERMINADO TAMANHO DA TELA
-A MANHA É SE DESFAZER DE ALGUMAS PROPRIEDADES DA PÁGINA PRA PODER MODIFICAR ELA ONDE VC QUER DE ACORDO COM O TAMANHO DA TELA
...
BACKGROUND IMAGE + LINEAR GRADIENT- IMAGEM DE FUNDO COM GRADIENTE
-COLOCAR ALTURA NO HTML E NO BODY
